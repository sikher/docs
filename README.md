...
_Please note that as of 20th of October 2013, ShabadID is now supported in GurbaniDB. Thanks to Harvinder Singh from khojgurbani.org for this data. ShabadID can be found in tblscripture which is part of gurbanidb_core.sql_
