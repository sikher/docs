...
**Please note:** As of 20th of October 2013, ShabadID is now supported in GurbaniDB. Thanks to Harvinder Singh from [khojgurbani.org](http://www.khojgurbani.org) for this data. ShabadID can be found in _tblscripture_ which is part of [gurbanidb_core.sql](http://www.sikher.com/sql/v1/gurbanidb_core.sql)
...
the correct {number}:
		...
		http://www.sikher.com/sql/v1/translation-{number}.sql
		
	Or...

		http://www.sikher.com/sql/v1/transliteration-{number}.sql
